...
class MyPagerIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < viewModel!.pages.length; ++i) {
      ...
      bool isActive = ((i == viewModel!.activeIndex) && percentActive! > 0.4 || (i != viewModel!.activeIndex && percentActive! > 0.6));

      bubbles.add(
        PageBubble(
          viewModel: PageBubbleViewModel(page.color, percentActive, isActive, viewModel!.selectedIndicatorColor, viewModel!.unSelectedIndicatorColor),
        ),
      );
    }
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              Opacity(
                opacity: (viewModel!.activeIndex == viewModel!.pages.length - 1 && viewModel!.slideDirection == SlideDirection.leftToRight
                    ? viewModel!.slidePercent!
                    : (viewModel!.activeIndex == viewModel!.pages.length - 2 && viewModel!.slideDirection == SlideDirection.rightToLeft)
              ...
              Opacity(
                opacity: (viewModel!.activeIndex == viewModel!.pages.length - 2 && viewModel!.slideDirection == SlideDirection.rightToLeft
                    ? viewModel!.slidePercent!
                    : (viewModel!.activeIndex == viewModel!.pages.length - 1 && viewModel!.slideDirection == SlideDirection.leftToRight)
                        ? (1 - viewModel!.slidePercent!)
                        : (viewModel!.activeIndex == viewModel!.pages.length - 1 ? 1 : 0)),
