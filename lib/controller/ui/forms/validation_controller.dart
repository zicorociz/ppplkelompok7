...
import 'package:stay_place/controller/ui/forms/basic_input_controller.dart';
...
class ValidationController extends MyController {
  ...
  ValidationController() {
    ...
    basicValidator.addField('password',
        required: true, label: "Password", validators: [MyLengthValidator(min: 6, max: 10)], controller: TextEditingController());
